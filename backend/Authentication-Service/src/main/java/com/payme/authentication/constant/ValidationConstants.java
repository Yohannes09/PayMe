...
public class ValidationConstants {
    ...
    public static final String PASSWORD_VALIDATION_MESSAGE = "Password must be 8+ characters long, have at least 1 capital letter, and a number or special character.";
